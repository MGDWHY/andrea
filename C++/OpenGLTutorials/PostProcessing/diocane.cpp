...
float rotation_degree = 0.0f; // The angle of <a title="rotation" href="http://www.swiftless.com/tutorials/opengl/rotation.html">rotation</a> in degrees for our teapot
