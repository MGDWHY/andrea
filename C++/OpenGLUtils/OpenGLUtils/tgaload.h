...
typedef void (APIENTRY * PFNGLCOMPRESSEDTEXSUBIMAGE1DARBPROC)(GLenum target, int level,
														  ...
														  GLenum format, GLsizei imageSize,
														  const GLvoid *data);
typedef void (APIENTRY * PFNGLGETCOMPRESSEDTEXIMAGEARBPROC)(GLenum target, int lod, 
														GLvoid *img);
...
unsigned int tgaLoadAndBind ( char *file_name, tgaFLAG mode );
